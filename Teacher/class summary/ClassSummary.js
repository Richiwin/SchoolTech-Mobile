...
const ClassSummary = ({navigation}) => {
  ...
  <Text style={styles.text}>Summary Of Classes</Text>
  <Text style={styles.text2}>Below is the summary of classes for the student</Text>
    <View style={styles.touchContainer}> 
    <TouchableOpacity style={styles.touchButton} >
    <Image source={require('../../Assets/Vector1.png')} style={styles.iconimg} />
    <Text style={styles.touchText}>Summary Of Classes</Text>
    </TouchableOpacity>
  ...
  <View>
    ...
    <Text style={styles.touchText}>Recent Activities</Text>
    </TouchableOpacity>
  </View>
