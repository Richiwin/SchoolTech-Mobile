...
const AttendanceDashboard = ({navigation}) => {
  ...
  <Text style={styles.text2}>Below is the attendance for the student</Text>
 ...
 onPress={() => {
    ...
    <Text style={styles.touchText}>Mark Attendance</Text>
    </TouchableOpacity>
  ...
  <View>
   ...
   onPress={() => {
    ...
    <Text style={styles.touchText}>View Attendance</Text>
    </TouchableOpacity>
  </View>
