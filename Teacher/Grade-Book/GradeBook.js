...
const GradeBook = ({navigation}) => {
    ...
    return (
      ...
      <Text style={styles.text}>GradeBook</Text>
      <Text style={styles.text2}>View upcoming events from the school</Text>
        ...
        <Text style={styles.touchText}>Enter Gradebook</Text>
        </TouchableOpacity>
      ...
      <View>
        ...
        <Text style={styles.touchText}>View Grades</Text>
        </TouchableOpacity>
      </View>
      </View>
