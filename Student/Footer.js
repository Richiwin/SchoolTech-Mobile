...
const Footer = () => {
  ...
  const [homeImage, setHomeImage] = useState(require('../Assets/Vector.png'));
  const [featureImage, setFeatureImage] = useState(require('../Assets/cup.png'));
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          onPress={() => {
            ...
            changeImage(setHomeImage, require('../Assets/home.png')); // Change to the active image
          }}>
          <View>
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            changeImage(setFeatureImage, require('../Assets/cup1.png')); // Change to the active image
          }}>
          <View>
